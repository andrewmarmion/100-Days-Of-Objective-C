...
- (void)loadPeople
{
    NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"people"];
    if (data) {
        NSError *error;
        NSArray *unarchivedPeople = [NSKeyedUnarchiver unarchivedArrayOfObjectsOfClass:Person.self
        ...
        self.people = [[NSMutableArray alloc] initWithArray:unarchivedPeople];
    }
}
